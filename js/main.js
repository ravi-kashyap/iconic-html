...
function sendMail(fullName, email, number, message) {
  Email.send({
	Host: "smtp.elasticemail.com",
	Username: "info@iconicfreightlogistics.com",
	Password: "373D23E3F2CC0670429FA412B8639780603C",
	To: 'info@iconicfreightlogistics.com',
	From: 'info@iconicfreightlogistics.com',
...
form.addEventListener('submit', (e) => {
  ...
  if (validateForm()) {
	...
	sendMail(fullName, email, number, message);
